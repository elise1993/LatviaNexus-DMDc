# LatviaNexus-DMDc
Supporting code and data for the paper Jonsson et. al. (2025) "Dynamic Mode Decomposition for Water-Energy-Food Nexus modelling: data-driven predictions of policy impacts" (in publishing).
...
Attribution and projection studies can be performed using the templates `example.py` and `example - ensemble.py`, respectively.
